...
@implementation ZKQuickTableDemoFiveVC
...
- (void)viewDidLoad {
    ...
    for (int i = 0; i < dataArray.count; i ++) {
        ...
        for (int j = 0; j < headerModel.cellList.count; j ++) {
            ...
            cellModel.type = ((arc4random()%50) % 2) + 1;
            ...
            else
            {
                ...
                cellModel.cellClassString = @"ZKQuickJsonDataTypeTwoCell";
                cellModel.isXibCell = YES;
                cellModel.saveCellHeight = 80;
            }
...
- (void)clickCellBlock:(ZKQuickJsonDataCellModel *)currentClickCellModel
{
    ...
    [self.quickTableTool.zk_tableView reloadRowsAtIndexPaths:@[currentClickCellModel.currentIndex] withRowAnimation:UITableViewRowAnimationNone];
